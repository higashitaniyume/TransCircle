...
> 💡 **專案目前狀態**：本專案目前正處於**非常初期的籌備與架構設計階段**。我們深知這個議題的複雜性，因此非常渴望聽取社群夥伴的各種聲音。如果你有任何想法、建議，或者純粹想和我們聊聊這個專案的走向，請隨時與我們交流，您可以[加入專案聊天群](https://transcircle.org/s/x-chat) 或在這個專案透過 issue 的形式提出您的建議。

> “我們的存在，就是對惡意最大的反抗。”

[简体中文](/README.md) 繁體中文-台灣 [繁體中文-香港](/README-zh_hk.md)

## 項目溯源

長此以往，中文 X（原 Twitter）MtF 社群有個很奇怪的現象：我們確實有比較全面的社群 wiki、HRT 指南等，但幾乎沒有一個能見證我們社群存在與抗爭的地方。

如果非要說的話，[one-among.us](https://one-among.us) 算是一個，但它只記錄了離去的人們，讓她們安息，也供我們緬懷。

但這不是全部。

跨性別社群流動性極大，因為很多人在完成轉變後順利地融入了社會，離開了這個社群。也有一些人在社會的惡意下選擇了離開。

這裡發生過很多故事，但沒有人把它們完整的記錄下來過。
...
如果您有任何有關 HRT 等方面的資源，也歡迎進行投稿。雖然推薦您投稿到 [Project-Trans](https://github.com/project-trans) 的專案中避免資源分散，但我們也接受投稿。

考慮到 [Project-Trans](https://github.com/project-trans) 通常使用 GitHub 投稿，我們也提供更低門檻的表單投稿方式。

## 🔒 隱私、安全與開源協議

我們將會接收匿名投稿，但建議您首選透過 X 或 GitHub OAuth 登入，避免冒充或濫用。如果您擔心隱私問題，請使用匿名投稿，但我們會仔細審查避免冒充。

您的所有投稿預設不會公開投稿者。如果您希望公開，請註明。

您的所有投稿將以 [CC BY SA 4.0 or later](https://creativecommons.org/licenses/by-sa/4.0/) 共享。歡迎社群其他專案根據此協議使用我們的內容。

## 如何參與

1. **加入專案組**：[填寫表單](https://transcircle.org/s/join) ，審核後加入我們的 X 群組和 GitHub 組織。

2. **投稿**：使用投稿頁面，分享您的故事

3. **技術支援**：對我們的專案提 issue 或 PR
